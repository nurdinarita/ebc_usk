            ...
            <div class="col-lg-12">
                <div class="breadcrumb_iner">
                    <div class="breadcrumb_iner_item">
                        ...
                        <p>@if(!isset($event)) Event Tidak Tersedia @endif</p>
                        <p>@if(isset($event)) @if(($dateNow->format('d M Y') > $event->registration_end_date->format('d M Y'))) Registrasi Telah Ditutup! @endif @endif</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form action="{{ isset($team) ? url('/register/'.$team->id) : url('/register')}}" method="post" enctype="multipart/form-data">@csrf
                        ...
                        <div class="mt-5">
                            <div class="form-select" >
                                ...
                                <select name="school" id="school" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="form-select" >
                                ...
                                <select name="match_category" id="match_category" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="form-select" >
                                ...
                                <select name="player_category" id="player_category" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                        ...
                        <div class="mt-5">
                            ...
                            <input type="text" name="team_name" id="team_name" placeholder="Nama Tim" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Tim'"
                                 class="single-input" value="{{ isset($team) ? $team->team_name : old('team_name') }}" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                            @if($errors->has('team_name')) <sup>{{ $errors->first('team_name') }}</sup> @endif
                        </div>
                        <div class="mt-3">
                            <label for="team_logo"><h6>Logo Tim</h6></label><br>
                            <input type="file" name="logo" id="team_logo" @if(!isset($team)) required @endif {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}><br>
                        ...
                        <div class="mt-3">
                            ...
                            <input type="text" name="address" id="address" placeholder="Alamat" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Alamat'"
                                 class="single-input" value="{{ isset($team) ? $team->address : old('address') }}" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                            @if($errors->has('address')) <sup>{{ $errors->first('address') }}</sup> @endif
                        </div>
                        <div class="mt-4">
                            <label for="city"><h6>Kota/Kabupaten</h6></label>
                            <div class="form-select" id="default-select">
                                <select name="city" id="city" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                        ...
                        <div class="mt-3">
                            ...
                            <input type="file" name="document" id="document" @if(!isset($team)) required @endif {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}><br>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="mt-5">
                                    ...
                                    <input type="text" name="coach_name" id="coach_name" placeholder="Nama Pelatih" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Pelatih'"
                                     class="single-input" value="{{ isset($team) ? $team->coach_name : old('coach_name') }}" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="mt-5">
                                    ...
                                    <input type="text" name="coach_nik" id="coach_nik" placeholder="Coach NIK" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Coach NIK'"
                                     class="single-input" value="{{ isset($team) ? $team->coach_nik : old('coach_nik') }}" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="text" name="coach_lisense" id="coach_lisense" placeholder="Nomor Lisensi Pelatih" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nomor Lisensi Pelatih'"
                                     class="single-input" value="{{ isset($team) ? $team->coach_lisense : old('coach_lisense') }}" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="file" name="coach_photo" id="coach_photo" @if(!isset($team)) required @endif {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}><br>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="mt-5">
                                    ...
                                    <input type="text" name="assistant_coach" id="assistant_coach" placeholder="Nama Asisten Pelatih" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Asisten Pelatih'"
                                     class="single-input" value="{{ isset($team) ? $team->assistant_coach : old('assistant_coach') }}" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="mt-5">
                                    ...
                                    <input type="text" name="assistant_coach_nik" id="assistant_coach_nik" placeholder="NIK Asisten Pelatih" onfocus="this.placeholder = ''" onblur="this.placeholder = 'NIK Asisten Pelatih'"
                                     class="single-input" value="{{ isset($team) ? $team->assistant_coach_nik : old('assistant_coach_nik') }}" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="text" name="assistant_coach_lisense" id="assistant_coach_lisense" placeholder="Nomor Lisensi Asisten Pelatih" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nomor Lisensi Asisten Pelatih'"
                                     class="single-input" value="{{ isset($team) ? $team->assistant_coach_lisense : old('assistant_coach_lisense') }}" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="mt-3">
                                    ...
                                    <input type="file" name="assistant_coach_photo" id="assistant_coach_photo" @if(!isset($team)) required @endif {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}><br>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                <div class="mt-5">
                                    ...
                                    <input type="text" name="manager_name" id="manager_name" placeholder="Nama Manager" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Manager'"
                                     class="single-input"value="{{ isset($team) ? $team->manager_name : old('manager_name') }}" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="mt-5">
                                    ...
                                    <input type="text" name="manager_nik" id="manager_nik" placeholder="NIK Manager" onfocus="this.placeholder = ''" onblur="this.placeholder = 'NIK Manager'"
                                     class="single-input" value="{{ isset($team) ? $team->manager_nik : old('manager_nik') }}" required {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="mt-5">
                                    ...
                                    <input type="file" name="manager_photo" id="manager_photo" @if(!isset($team)) required @endif {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}><br>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="mt-3">
                                    ...
                                    <input type="text" name="p_name_{{ $i }}" id="p_name_{{ $i }}" placeholder="Nama Pemain {{ $i }}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Pemain {{ $i }}'"
                                     class="single-input" value="{{ isset($team['p_name_'.$i]) ? $team['p_name_'.$i] : old('p_name_'.$i) }}" {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="mt-3">
                                    ...
                                    <input type="text" name="p_nik_{{ $i }}" id="p_nik_{{ $i }}" placeholder="NIK Pemain {{ $i }}" onfocus="this.placeholder = ''" onblur="this.placeholder = 'NIK Pemain {{ $i }}'"
                                     class="single-input" value="{{ isset($team['p_nik_'.$i]) ? $team['p_nik_'.$i] : old('p_nik_'.$i) }}" {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="col-lg-6 col-md-6">
                                    <div class="mt-3">
                                        ...
                                        <input type="file" name="p_photo_{{ $i }}" id="p_photo_{{ $i }}" {{ isset($event) && $event->registration_end_date->format('d M Y') < $dateNow->format('d M Y') ? 'disabled' : '' }} {{ !isset($event) ? 'disabled' : '' }}><br>
                        ...
                        <div class="mt-5">
                            @if(isset($event))
                                @if(!($dateNow->format('d M Y') > $event->registration_end_date->format('d M Y')))
